...
$a_u$: That is, writing $\Bbb1{P}_{x_p}[\cdot]$ to indicate the probability that an event is true when sampled over all positions and 
images, we define the threshold $t_u \equiv max_t\Bbb1{P}_{x_p}[a_u(x , p) > t]\geq 0.01$.
